...
router.get('/test', async (req, res) => {
	...
	const findUserWithClassesTeacher =  await User.findById('5f72458d9f35d035709cf89f').populate({path: 'teacherClasses', populate: {path: 'students teachers'}}).exec();
	const findUserWithClassesStudent =  await User.findById('5f723fc2349d7c256c6cf3aa').populate({path: 'studentClasses', populate: {path: 'students teachers'}}).exec();
	const findUser =  await User.findById('5f72458d9f35d035709cf89f').exec();
